...
char* sloCommAgent::GetCurTime(int nAddYear)
{
	...
	sprintf(pszTime,"%04d-%02d-%02d %02d:%02d:%02d",
		stTime.wYear + nAddYear, stTime.wMonth, stTime.wDay, stTime.wHour, stTime.wMinute, stTime.wSecond);
	return pszTime;
}
...
BOOL sloCommAgent::DoFileDialog(BOOL bOpenFileDialog, char *szPath, LPCTSTR lpszFilter,LPCTSTR lpszDefExt,LPCTSTR lpszFileName/* = NULL*/)
{
