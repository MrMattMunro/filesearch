...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT /*lpcs*/, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CShortcutBarView), CSize(0, 200), pContext);

//	m_wndSplitter2.CreateStatic(&m_wndSplitter, 1, 1, WS_CHILD|WS_VISIBLE, m_wndSplitter.IdFromRowCol(0, 1));
...
//	m_wndSplitter2.CreateView(1, 0, RUNTIME_CLASS(CShortcutBarView), CSize(0, 0), pContext);
	...
	m_pShortcutBarView = (CShortcutBarView*)m_wndSplitter.GetPane(0,1);
