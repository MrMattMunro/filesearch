...
IMPLEMENT_DYNCREATE(CShortcutBarSplitter, CXTSplitterWndEx)
...
BEGIN_MESSAGE_MAP(CShortcutBarSplitter, CXTSplitterWndEx)
...
void CShortcutBarSplitter::TrackColumnSize(int x, int col)
{
	...
	{
		// resized too small
		m_pColInfo[col].nIdealSize = 33; // make it go away
	}
}