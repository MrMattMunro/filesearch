...
Resource2=IDD_DIALOG_CREATE_INDEX (Chinese (P.R.C.))
Class4=CModifyIndexDlg
Resource3=IDD_DIALOG_MODIFY_INDEX
Class5=CShowAllCiHuiDlg
Resource4=IDD_DIALOG_LICENSE (Chinese (P.R.C.))
Class6=CSetAttributeDlg
Resource5=IDD_DIALOG_SKIN (Chinese (P.R.C.))
Class7=CFastSearchDlg
Class8=CSearchThread
Resource6=IDD_DIALOG_ALL_CIHUI (Chinese (P.R.C.))
Class9=CLicenseDlg
Resource7=IDD_DIALOG_SET_ATTR
Class10=CSkinDlg
Resource8=IDD_DIALOG_CUSTOM_DICT
Resource9=IDD_DIALOG_CUSTOM_DICT (Chinese (P.R.C.))
Resource10=IDD_DIALOG_MODIFY_INDEX (Chinese (P.R.C.))
Resource11=IDD_DIALOG_SKIN
Resource12=IDD_DIALOG_SET_ATTR (Chinese (P.R.C.))
Resource13=IDD_DIALOG_FAST_SEARCH (Chinese (P.R.C.))
Resource14=IDD_DIALOG_CREATE_INDEX
Resource15=IDD_DIALOG_ALL_CIHUI
...
Control3=IDC_STATIC_NEW_WORDS,static,1342308352
...
Control1=IDOK,button,1342242817
Control2=IDCANCEL,button,1342242816
Control3=IDC_STATIC_SEARCH_DIR,static,1342308352
Control4=IDC_EDIT_SEARCH_PATH,edit,1350633600
Control5=IDC_BUTTON_BROWSE,button,1342242816
Control6=IDC_STATIC_OBJECT_TYPE,static,1342308352
Control7=IDC_CHECK_EXCEL,button,1342242819
Control8=IDC_CHECK_WORD,button,1342242819
Control9=IDC_CHECK_PPT,button,1342242819
Control10=IDC_CHECK_PDF,button,1342242819
