...
Resource3=IDD_DIALOG_FAST_SEARCH (Chinese (P.R.C.))
Class5=CShowAllCiHuiDlg
Resource4=IDD_DIALOG_CREATE_INDEX (Chinese (P.R.C.))
Class6=CSetAttributeDlg
Resource5=IDD_DIALOG_CUSTOM_DICT
...
Class10=CSkinDlg
Resource8=IDD_DIALOG_LICENSE (Chinese (P.R.C.))
Resource9=IDD_DIALOG_SKIN (Chinese (P.R.C.))
Resource10=IDD_DIALOG_ALL_CIHUI (Chinese (P.R.C.))
Resource11=IDD_DIALOG_CREATE_INDEX
Resource12=IDD_DIALOG_MODIFY_INDEX (Chinese (P.R.C.))
Resource13=IDD_DIALOG_SET_ATTR (Chinese (P.R.C.))
