...
public class JPCreateNewFrame extends CFrame implements ActionListener {

	private static final long serialVersionUID = 1L;

	static JPCreateNewFrame c;
	...
	public JPCreateNewFrame() {
		...
		panel.makeLabel(msg.getMsgbyId(Constant.label_searchname), 90, 20, 130, 25);
		searchnamefield = panel.makeTextField(170, 20, 120, 20);
		searchnamefield.setEditable(true);

		panel.makeLabel(msg.getMsgbyId(Constant.label_searchdir), 50, 55, 120, 25);
		...
		panel.makeLabel(msg.getMsgbyId(Constant.label_indexdir), 30, 80, 150, 25);
		...
		panel.makeLabel(msg.getMsgbyId(Constant.label_doc), 70, 125, 120, 25);
		...
		JButton confirmbutton = panel.makeButton(msg.getMsgbyId(Constant.button_confirm), 150, 170, 80, 20, "");
		...
		JButton cancelbutton = panel.makeButton(msg.getMsgbyId(Constant.button_cancel), 250, 170, 80, 20,"");
