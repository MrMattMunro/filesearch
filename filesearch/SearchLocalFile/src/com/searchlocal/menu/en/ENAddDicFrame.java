...
public class ENAddDicFrame extends CFrame implements ActionListener {
	...
	public ENAddDicFrame() {
        ...
        // 确认
		JButton confirmbutton = panel.makeButton(msg.getMsgbyId(Constant.button_confirm), 170, 210, 70, 20, "");
		...
		// 取消按钮
		JButton cancelbutton = panel.makeButton(msg.getMsgbyId(Constant.button_cancel), 250, 210, 70, 20,"");
