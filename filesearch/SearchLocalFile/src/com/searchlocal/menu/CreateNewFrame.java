...
public class CreateNewFrame extends CFrame implements ActionListener {
	...
	public CreateNewFrame() {
		...
		JButton selectdirbotton = panel.makeButton(msg.getMsgbyId(Constant.button_select),370, 45, 42, 20,"");
		...
		selectindexdirbotton = panel.makeButton(msg.getMsgbyId(Constant.button_select),370, 80, 42, 20,"");
		...
		JButton confirmbutton = panel.makeButton(msg.getMsgbyId(Constant.button_confirm), 150, 150, 70, 20, "");
		...
		JButton cancelbutton = panel.makeButton(msg.getMsgbyId(Constant.button_cancel), 230, 150, 70, 20,"");
