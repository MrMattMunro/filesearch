    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            [ 'savehtml', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage', 'emotion', 'insertvideo', 'map','source', 'gmap', 'insertframe','highlightcode','webapp','pagebreak', '|',
        ...
        ,labelMap:{
            ...
            'emotion':'表情', 'spechars':'特殊字符', 'searchreplace':'查询替换', 'map':'Baidu地图', 'savehtml':'保存', 'gmap':'Google地图',
