...
void ToolbarSearch::searchNow()
{
    ...
    QUrlQuery q;
    q.addQueryItem(QLatin1String("q"), searchText);
    q.addQueryItem(QLatin1String("ie"), QLatin1String("UTF-8"));
    q.addQueryItem(QLatin1String("oe"), QLatin1String("UTF-8"));
    q.addQueryItem(QLatin1String("client"), QLatin1String("qtdemobrowser"));
    url.setQuery(q);

    q.query(QUrl::FullyEncoded).toUtf8();
    emit search(url);
}
