...
public class ENOptionSetFrame extends CFrame implements ActionListener {

	private static final long serialVersionUID = 1L;

	static ENOptionSetFrame c;
	...
	public ENOptionSetFrame() {
		...
		// discribtion
		panel.makeLabel(msg.getMsgbyId(Constant.title_setopenersoft), 60, 10, 160, 25);

		// IE DIR
		panel.makeLabel("IE:   ", 60, 30, 40, 25);
		iedir = panel.makeTextField(110, 30, 270, 20);
		iedir.setEditable(false);
		JButton selectiedirbotton = panel.makeButton(select, 390, 30, 60, 20, "");
		...
		JButton selectworddirbotton = panel.makeButton(select, 390, 60, 60, 20, "");
		...
		JButton selectexceldirbotton = panel.makeButton(select, 390, 90, 60, 20, "");
		...
		JButton selectpptdirbotton = panel.makeButton(select, 390, 120, 60, 20, "");
		...
		JButton selectpdfdirbotton = panel.makeButton(select, 390, 150, 60, 20, "");
		...
		JButton selecttxtdirbotton = panel.makeButton(select, 390, 180, 60, 20, "");
	...
	public static void main(String[] args) {
		try {
			ENOptionSetFrame frame = new ENOptionSetFrame();
			frame.showframe();
		} catch (UnsupportedLookAndFeelException e) {
			// TODO 自动生成 catch 部分
			e.printStackTrace();
