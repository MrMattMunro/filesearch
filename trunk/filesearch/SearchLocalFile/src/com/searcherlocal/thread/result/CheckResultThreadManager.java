/**
 * $RCSfile: CheckResultThreadManager.java
 * $Revision: 1.0
 * $Date: Jan 30, 2011
 *
 ...
 *  监控检索结果对象的线程管理类
 * 
 * <p>Title:  监控检索结果对象的线程管理类</p>
 * <p>Description: </p>
 * <p>site: www.slfile.net</p>
 * @author changsong:qianjinfu@gmail.com
 * @version 1.0
 */
public class CheckResultThreadManager {

	/** 线程管理类 */
	public static CheckResultThreadManager manage = null;
	 ...
	 * 构造器
	 */
	public CheckResultThreadManager() {
	 ...
	 * @return 线程管理类
	 */
	public static CheckResultThreadManager getThreadManager() {
		if (null == manage) {
			manage = new CheckResultThreadManager();
		}
		return manage;
	}
}
