...
public class OptionSetFrame extends CFrame implements ActionListener {

	private static final long serialVersionUID = 1L;

	static OptionSetFrame c;
	...
	public OptionSetFrame() {
		...
		// discribtion
		panel.makeLabel(msg.getMsgbyId(Constant.title_setopenersoft), 60, 10, 120, 25);
