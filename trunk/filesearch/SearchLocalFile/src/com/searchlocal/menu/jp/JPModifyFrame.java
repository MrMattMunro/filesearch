...
public class JPModifyFrame extends CFrame implements ActionListener {
	...
	public JPModifyFrame(CreateNewParam param) {
		...
		JButton confirmbutton = panel.makeButton(msg.getMsgbyId(Constant.button_confirm), 100, 190,
				90, 20, "");
		...
		JButton cancelbutton = panel.makeButton(msg.getMsgbyId(Constant.button_cancel), 290, 190,
				80, 20, "");
