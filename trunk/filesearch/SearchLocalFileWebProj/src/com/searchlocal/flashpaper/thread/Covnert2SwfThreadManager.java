...
import com.web.searchlocal.thread.base.CThreadPoolExecutor;
 ...
 * @version 1.0
 */
public class Covnert2SwfThreadManager {

	/** 线程管理类 */
	public static Covnert2SwfThreadManager manage = null;
	 ...
	 * 构造器
	 */
	public Covnert2SwfThreadManager() {
	 ...
	 * @return 线程管理类
	 */
	public static Covnert2SwfThreadManager getThreadManager() {
		if (null == manage) {
			manage = new Covnert2SwfThreadManager();
		}
		return manage;
	}
}
